  ...
  return (
    ...
    >
      <DialogTrigger asChild>
        <button
          className={`flex items-center gap-2 px-4 font-semibold uppercase transition-all duration-200 ${
      ...
      >
        <DialogHeader>
          <DialogTitle className="font-brand font-bold">How to use</DialogTitle>
          <DialogDescription>
